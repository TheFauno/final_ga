...
-- -----------------------------------------------------
-- Table `FLOW_TRUCK`.`PATH`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `FLOW_TRUCK`.`PATH` ;

CREATE TABLE IF NOT EXISTS `FLOW_TRUCK`.`PATH` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `NAME` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `FLOW_TRUCK`.`ASSIGNMENT` (
  ...
  INDEX `fk_ASSIGNMENT_TRUCK1_idx` (`TRUCK_ID` ASC, `SHOVEL_ID` ASC) VISIBLE,
  INDEX `fk_ASSIGNMENT_LOAD1_idx` (`SHOVEL_ID` ASC) VISIBLE,
  CONSTRAINT `fk_ASSIGNMENT_TRUCK1`
    FOREIGN KEY (`TRUCK_ID` , `SHOVEL_ID`)
    REFERENCES `FLOW_TRUCK`.`TRUCK` (`ID` , `ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ASSIGNMENT_LOAD1`
...
CREATE TABLE IF NOT EXISTS `FLOW_TRUCK`.`TRUCK_FLOW` (
  ...
  INDEX `fk_TRUCK_FLOW_TRUCK_idx` (`TRUCK_ID` ASC) VISIBLE,
